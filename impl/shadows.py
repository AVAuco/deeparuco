...
if __name__ == '__main__':
    ...
    circular = circular(width, height)

    cv2.imwrite('gradient.png', gradient * 255.0)
    cv2.imwrite('perlin.png', perlin * 255.0)
    cv2.imwrite('lines.png', lines * 255.0)
    cv2.imwrite('circular.png', circular * 255.0)
    cv2.imwrite('combined.png', lines * perlin * gradient * circular * 255.0)